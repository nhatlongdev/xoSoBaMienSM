     ...
     render() {
         return (
            <SafeAreaView style = {{flex: 1, marginHorizontal: 2,marginBottom:5}}>
                ...
                <View style={{flexDirection: 'row', backgroundColor: GlobalValue.Color.yellow_light, borderBottomColor: 'grey', borderBottomWidth: 1, paddingVertical: 2}}>
                    <Text style={{flex: 1, textAlign: 'center', color: 'black', fontWeight: 'bold'}}>Số</Text>
                    <Text style={{flex: 6, textAlign: 'center', justifyContent: 'center' , color: 'black', fontWeight: 'bold'}}>Số ngày chưa ra</Text>
                </View>
                <FlatList
